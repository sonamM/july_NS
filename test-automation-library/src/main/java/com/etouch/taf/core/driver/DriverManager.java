...
public class DriverManager {
	...
	private static void buildDriverMap(){
		...
		{        
		   ...
		   DriverBuilder driver=(DriverBuilder)createDriver(clazz.getName(), testBed);
		 ...
		 * @throws DriverException the driver exception
		 */
		private static DriverBuilder createDriver( String className,TestBed testBed) throws DriverException{
			Class<?> clazz;
