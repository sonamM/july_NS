...
public class AmazonMainPage extends CommonPage {
	...
	public void SignIn() throws InterruptedException, PageException
	{
		...
		webPage.findObjectById("ap_email").sendKeys("");
		webPage.findObjectById("ap_password").sendKeys("");
	...
	public void SignInWithITafElement() throws InterruptedException, PageException
	{
		...
		(webPage.findObjectById("ap_email")).sendKeys("lavanyaa");
		(webPage.findObjectById("ap_email")).sendKeys(Keys.BACK_SPACE);
