...
public class TestAmazonMainPage extends BaseTest {
	 ...
	 */
	@BeforeClass
	public void prepareBeforeClass(ITestContext context) throws Exception {
		try {

			synchronized(this){
			
			webPage = new WebPage(context);
			//if(!TestBedManager.INSTANCE.getCurrentTestBed().getTestBedName().equals("Chrome")){
			//	Thread.sleep(30000);
			//}
	...
	//public void testSignIn() throws PageException {
		try {
			...
			{	
				stopRecording(isRecordingStopped);
			}
	...
	private void stopRecording(boolean isRecordingStopped) {
	...
	public void tearDown(ITestContext context){
		...
		//TODO move the below code to TestUtil
		TestBed testBed=TestBedManager.INSTANCE.getCurrentTestBeds().get(testBedName);
		TestUtil.closeDriver((WebDriver)testBed.getDriver());
